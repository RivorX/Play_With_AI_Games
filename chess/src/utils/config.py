...
_RL_KEY_ALIASES = {
    ...
    'losses.policy_anchor_kl': 'policy_anchor_kl_weight',
    ...
    'losses.value_std_floor': 'value_std_floor_loss_weight',
    'losses.value_std_target_ratio': 'value_std_floor_target_ratio',
...
_RL_DEFAULTS = {
    ...
    'self_play_opening_diversity_enabled': True, 'self_play_opponent_pool_enabled': True,
    'self_play_randomize_learner_color': True, 'self_play_store_frozen_best_positions': True,
    'mcts_reuse_tree': True, 'mcts_cache_history_tensors': True, 'mcts_use_fpu': True,
    ...
    'no_decay_weight_decay': 0.0, 'post_promotion_lr_recovery_iterations': 2,
    'rl_diagnostic_ema_alpha': 0.35, 'use_lr_schedule': True,
    'policy_target_confidence_weighting_enabled': True, 'use_augmentation': True,
    ...
    'replay_dynamic_cap_enabled': True,
    ...
    'eval_no_mcts_enabled': True, 'eval_no_mcts_every': 1,
    ...
    'eval_funnel_preliminary_true_win_rate': 0.0, 'eval_funnel_preliminary_result_weight': 0.50,
    ...
    'anchor_eval_enabled': True, 'anchor_eval_every': 4,
    'anchor_eval_mcts_simulations': 'auto', 'anchor_eval_mcts_simulations_multiplier': 1.25,
    'anchor_eval_use_fixed_openings': True, 'early_stop_enabled': True,
    'early_stop_patience_increment_on_promotion': 2, 'early_stop_min_score_improvement': 0.01,
    'early_stop_min_true_win_improvement': 0.005, 'value_metric_weight_min': 0.20,
