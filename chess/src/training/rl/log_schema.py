...
RL_MAIN_COLUMNS = (
    ...
    "correction_audit_target_kl_before", "correction_audit_target_kl_after",
    "correction_audit_target_kl_reduction",
    "correction_audit_target_kl_closed_fraction",
    "correction_audit_retention", "correction_audit_retention_rows",
    "holdout_rows",
    "holdout_policy_kl_before", "holdout_policy_kl_after",
    "holdout_policy_kl_reduction",
    "holdout_value_wdl_ce_before", "holdout_value_wdl_ce_after",
    "holdout_value_wdl_ce_reduction",
    "holdout_value_brier_before", "holdout_value_brier_after",
    "holdout_value_brier_reduction",
    "holdout_value_mae_before", "holdout_value_mae_after",
    "holdout_value_mae_reduction",
    ...
    "no_mcts_score_lower_bound", "no_mcts_score_upper_bound", "mcts_no_mcts_gap",
...
RL_DATA_QUALITY_COLUMNS = (
    ...
    "positions_added", "holdout_positions", "holdout_games", "holdout_fraction",
    "replay_candidate_positions", "played_positions",
    ...
    "train_replay_passes", "replay_games", "replay_positions_per_game_mean",
    "replay_positions_per_game_p90", "train_game_coverage",
    ...
    "selfplay_actor", "selfplay_best_reason", "selfplay_best_vs_best",
    ...
    "holdout_value_mae_before", "holdout_value_mae_after",
    "holdout_value_mae_reduction",
    "learner_guard_failures", "learner_actor_safe",
...
RL_PERFORMANCE_COLUMNS = (
    ...
    "central_compact_policy_rate", "central_compact_output_mib_avoided",
