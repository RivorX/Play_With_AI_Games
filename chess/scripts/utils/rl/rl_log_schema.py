...
RL_MAIN_COLUMNS = (
    ...
    "search_q_loss", "search_error_loss", "search_q_coverage", "search_q_mae",
    "search_error_mae", "search_error_pred_mean", "search_error_target_mean",
    "learning_rate", "value_loss_weight",
    "temperature", "policy_top1_acc", "policy_top3_acc",
    "policy_correction_loss", "policy_correction_top1_acc",
    ...
    "actor_status", "actor_iteration",
    "actor_reference_score_rate", "actor_reference_no_mcts_score_rate",
    "actor_score_delta", "actor_no_mcts_score_delta",
    "actor_updated", "actor_anchor_verified",
    "rl_best_model",
...
RL_DATA_QUALITY_COLUMNS = (
    ...
    "mcts_avg_budget",
    "mcts_full_search_samples", "mcts_fast_search_samples", "mcts_full_search_fraction",
    ...
    "mcts_difficulty_mean", "mcts_full_search_difficulty_mean",
    "mcts_fast_search_difficulty_mean", "mcts_difficulty_budget_correlation",
